.onAttach = function(libname, pkgname){
  ...
  packageStartupMessage("   We recommend you re-install the package before each use to get all recent updates, using: devtools::install_github('rosalieb/serac', build_vignettes = TRUE)")
  packageStartupMessage("   Citation: Bruel and Sabatier (2020) Journal of Environmental Radioactivity - 10.1016/j.jenvrad.2020.106449")
}
